  ...
  >
    ...
    <Slide bgColor="primary" textColor="tertiary">
      ...
      <Notes>
        ...
        <br/>
        <br/>
        В заключение я оценю стоимость миграции клинерского приложения на GraphQL на фронтенде
    ...
    <Slide bgColor="primary">
      ...
      <Notes>
        ...
        Количество кода меньше в 4 с лишним раза, места для багов стало меньше.
        Ниже ссылка на статью об опыте миграции
      </Notes>
    </Slide>
    ...
    <Slide>
      ...
      <Table style={{ borderSpacing: '0 20px', color: colors.white }}>
        ...
        <Notes>
          ...
          В сагах нам приходится вручную запрашивать данные после запроса,
    ...
    <Slide bgColor="primary">
      ...
      <Notes>
        Любая задача сильно завязана на коммуникации фронтендера с бэкендером.
        <br/>
        Новый эндпоинт даже для существующих моделей.
        <br/>
    ...
    <Slide bgColor="primary">
      ...
      <Notes>
        ...
        При надобности можно добавлять типам description и это будет отображаться.
    ...
    <Slide bgColor="dracula">
      ...
      <Notes>
        ...
        затем делать запрос на бэк. Можем делать запрос каждый раз, можем только использовать кеш.
      </Notes>
    </Slide>
    <Slide bgColor="dracula">
    ...
    <Slide>
      ...
      <Table style={{ borderSpacing: '0 15px', color: colors.white }}>
        ...
        <Notes>
          ...
          В мутации мы можем описать нужные данные и они вернутся в рамках одного запроса.
          <br/>
          <br/>
          На сервере валидируются действия с заказом, изменения расписания и графика,
          запросы на компенсацию химии и прохождения онлайн воронки.
          <br/>
          <br/>
